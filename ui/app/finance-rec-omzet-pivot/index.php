         ...
         <v-app id="oneApp" v-if="one_token" >
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <finance-rec-omzet-pivot-list></finance-rec-omzet-pivot-list>
                        <finance-rec-omzet-degrade></finance-rec-omzet-degrade>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
methods : {
   ...
   components: {
        ...
        "finance-rec-omzet-pivot-list" : httpVueLoader("./components/finance-rec-omzet-pivot-list.vue"),
        "finance-rec-omzet-degrade" : httpVueLoader("./components/finance-rec-omzet-degrade.vue")
      }
    })
    </script>
    <style>
