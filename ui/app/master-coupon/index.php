         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <master-coupon-list></master-coupon-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <master-coupon-new></master-coupon-new>
         </v-app>
      </div>
...
methods : {
   ...
   components: {
        ...
        "master-coupon-list" : httpVueLoader("./components/master-coupon-list.vue?t=<?=$ts;?>"),
        "master-coupon-new" : httpVueLoader("./components/master-coupon-new.vue?t=<?=$ts;?>")
      }
    })
    </script>
    <style>
