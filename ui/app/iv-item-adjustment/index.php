...
methods : {
   ...
   components: {
        ...
        "iv-item-adjustment-list" : httpVueLoader("./components/iv-item-adjustment-list.vue<?php echo $ts ?>"),
        "iv-item-adjustment-new" : httpVueLoader("./components/iv-item-adjustment-new.vue<?php echo $ts ?>"),
        "iv-item-adjustment-item-list" : httpVueLoader("./components/iv-item-adjustment-item-list.vue<?php echo $ts ?>")
      }
    })
    </script>
    <style>
