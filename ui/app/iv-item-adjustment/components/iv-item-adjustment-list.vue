        ...
        <v-card-text class="pt-2">
            <v-data-table 
                ...
                <template slot="items" slot-scope="props">
                    ...
                    <td class="text-xs-center pa-2" @click="select(props.item)">{{ props.item.I_AdjustNumber }}</td>
...
module.exports = {
    ...
    computed : {
        ...
        edate : {
            get () { return this.$store.state.adjustment.e_date },
            set (v) { this.$store.commit('adjustment/set_edate', v) }
        },

        sdate : {
            get () { return this.$store.state.adjustment.s_date },
