...
methods : {
   ...
   components: {
        ...
        "crm-info-list" : httpVueLoader("./components/crm-info-list.vue<?=$ts;?>"),
        "crm-info-new" : httpVueLoader("./components/crm-info-new.vue<?=$ts;?>"),
        "crm-info-preview" : httpVueLoader("./components/crm-info-preview-dialog.vue<?=$ts;?>")
      }
    })
    </script>
    <style>
