<template>
    <v-card>
        <v-card-title primary-title class="pt-2 pb-0">
            <v-layout row wrap>
                <v-flex xs4>
                    <h3>DAFTAR <span class="orange--text">PEMBAYARAN</span> TRANSAKSI</h3>
                </v-flex>
                <v-flex xs2>
                    <common-datepicker
                        label="Dari Tanggal"
            ...
            <v-data-table 
                ...
                <template slot="items" slot-scope="props">
                    ...
                    <td class="text-xs-center  pa-2" @click="select(props.item)">
                        <v-spacer></v-spacer><v-img :src="'../'+props.item.expedition_logo" height="24" width="48" position="center center" class="img-zalfa-exp-logo-small"></v-img>
                        {{ props.item.expedition_name }}, {{ props.item.expedition_service }}
                    </td>
                    ...
                    <td class="text-xs-center py-0 pl-0 pr-1" @click="select(props.item)">
                        <v-layout row wrap>
                            <v-flex xs6>
                                <v-btn color="orange" block dark class="ma-0 btn-icon" small title="Verifikasi Pembayaran"><v-icon class="mr-1">check</v-icon> Ver</v-btn>        
                            </v-flex>
                            <v-flex xs6 pl-1>
                                <v-btn color="red" block dark class="ma-0 btn-icon" small title="Pembatalan Order">Batal</v-btn>        
                            </v-flex>
                        </v-layout>
