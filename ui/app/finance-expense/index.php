         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <finance-expense-list></finance-expense-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <finance-expense-new></finance-expense-new>
         </v-app>
      </div>
...
methods : {
   ...
   components: {
        ...
        "finance-expense-list" : httpVueLoader("./components/finance-expense-list.vue"),
        "finance-expense-new" : httpVueLoader("./components/finance-expense-new.vue")
      }
    })
    </script>
    <style>
