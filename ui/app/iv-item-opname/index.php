         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <iv-item-opname-list></iv-item-opname-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <iv-item-opname-new></iv-item-opname-new>
            <iv-item-opname-item-list></iv-item-opname-item-list>
         </v-app>
      </div>
...
methods : {
   ...
   components: {
        ...
        "iv-item-opname-list" : httpVueLoader("./components/iv-item-opname-list.vue"),
        "iv-item-opname-new" : httpVueLoader("./components/iv-item-opname-new.vue"),
        "iv-item-opname-item-list" : httpVueLoader("./components/iv-item-opname-item-list.vue")
      }
    })
    </script>
    <style>
