         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <master-bank-account-list></master-bank-account-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <master-bank-account-new></master-bank-account-new>
         </v-app>
      </div>
...
mounted: function() {
    ...
    this.$store.dispatch('bankaccount_new/search_bank', {})
},
computed : {
    one_token () {
...
methods : {
   ...
   components: {
        ...
        "master-bank-account-list" : httpVueLoader("./components/master-bank-account-list.vue"),
        "master-bank-account-new" : httpVueLoader("./components/master-bank-account-new.vue")
      }
    })
    </script>
    <style>
