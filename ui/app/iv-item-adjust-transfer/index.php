         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <iv-item-adjust-transfer-list></iv-item-adjust-transfer-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
methods : {
   ...
   components: {
        ...
        "iv-item-adjust-transfer-list" : httpVueLoader("./components/iv-item-adjust-transfer-list.vue<?php echo $ts ?>")
      }
    })
    </script>
    <style>
