    ...
    >
        <v-card>
            <v-card-title primary-title class="blue white--text pt-2 pb-2">
                <h3 class="headline">UBAH USERNAME</h3>
                <v-spacer></v-spacer>
                ...
                <v-layout row wrap>
                    ...
                    <v-flex xs12>
                        <v-text-field
                            ...
                            :error-messages="error_password ? ['Password yang Anda masukkan tidak sesuai'] : []"
                        ></v-text-field>
                    </v-flex>
...
module.exports = {
    components : {
        ...
        'user-fee' : httpVueLoader('./user-fee.vue')
    },
    ...
    computed : {
        ...
        dialog : {
            get () { return this.$store.state.user_new.dialog_username },
            set (v) { this.$store.commit('user_new/set_common', ['dialog_username', v]) }
        },
        ...
        old_user_name () {
            return this.$store.state.user_new.old_user_name
        },

        username_error () {
            return this.$store.state.user_new.username_error
        },

        username_error_text () {
            return this.$store.state.user_new.username_error_text
        }
    },

    methods : {
        save () {
            this.$store.dispatch('user_new/username_change')
        },
