...
mounted: function() {
    ...
    this.$store.dispatch('user_new/search_customer_level')
},
computed : {
   one_token () {
...
methods : {
   ...
   components: {
        ...
        "user-group-list" : httpVueLoader("./components/user-group-list.vue"),
        "user-list" : httpVueLoader("./components/user-list.vue<?php echo $ts ?>")
      }
    })
    </script>
    <style>
