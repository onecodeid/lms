         ...
         <v-app id="oneApp" v-if="one_token" >
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <finance-payment-cod-list></finance-payment-cod-list>
                        <finance-payment-cod-new></finance-payment-cod-new>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
methods : {
   ...
   components: {
        ...
        "finance-payment-cod-list" : httpVueLoader("./components/finance-payment-cod-list.vue"),
        "finance-payment-cod-new" : httpVueLoader("./components/finance-payment-cod-new.vue"),
        // "finance-cod-admin-show" : httpVueLoader("./components/finance-cod-admin-show.vue")
      }
    })
    </script>
    <style>
