        ...
        <v-flex xs6>
            <v-card>
                ...
                <v-card-actions>
                    ...
                    <v-spacer></v-spacer>
                    <v-btn color="primary" @click="confirm" v-if="selected_order.payment_code=='TRANSFER'" :disabled="!btn_payment_enable">Konfirmasi</v-btn>
                    <v-btn color="primary" @click="confirm_cod" v-if="selected_order.payment_code=='COD.FREE'">Konfirmasi</v-btn>
