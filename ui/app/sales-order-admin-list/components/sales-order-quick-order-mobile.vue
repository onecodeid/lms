<template>
    ...
    >
        <v-card>
            <v-card-title primary-title class="primary white--text pt-2 pb-2 px-2">
                <v-layout row wrap>
                    <v-flex xs12 sm6>
                        ...
                        <h3 class="headline" :class="{'text-xs-center pr-4':$vuetify.breakpoint.xsOnly}">QUICK ORDER</h3>        
                    </v-flex>
            ...
            <v-card-text class="px-2">
                <v-layout row wrap>
                    ...
                    <v-flex xs12 sm7>
                        <v-layout row wrap>
                            <v-flex xs12 v-for="(item,i) in items" :key="i" mb-1>
                                <v-card>
                            ...
                            <v-flex xs12 v-for="(item,i) in packets" :key="'p-'+i" mb-1>
                                <v-card>
                    ...
                    <v-flex xs12 sm5 :class="{'pl-2':$vuetify.breakpoint.smAndUp}">
                        <div style="position:sticky;top:0">
                            <v-text-field
                                ...
                                :hide-details="selected_customer&&cust_id!=0&&selected_customer.customer_note.length>0"
                            >
                            ...
                            <v-layout row wrap>
                                <v-flex xs12>
                                    <v-card depressed flat class="zalfa-card-dashed mb-2 mt-2" v-if="selected_customer&&cust_id!=0&&selected_customer.customer_note.length>0">
            ...
            <v-card-actions class="primary lighten-3 hidden-sm-and-down">
                <v-layout row wrap>
                    <v-flex xs4>
                        <div class="white--text font-weight-bold body-2">
                        <v-icon class="mr-1 red--text">send</v-icon>
                        Ekspedisi : 
                        ...
                        <a href="#" class="ml-2 red--text" @click="edit_expedition" 
                            v-show="!expedition_set">[ Ekspedisi belum dipilih ! ]</a></div>
                    </v-flex>
                    <v-flex xs4 class="text-xs-right" offset-xs4>
                        <v-spacer></v-spacer>
            ...
            <v-card-actions class="primary lighten-3 hidden-md-and-up pa-0">
                <v-layout row wrap>
                    <v-flex xs12 sm5 offset-xs0 offset-sm7>
                        <v-btn color="primary" @click="edit_expedition" large block :disabled="!btn_exp_enable">
                            <h3 class="headline">PENGIRIMAN</h3> <v-icon class="ml-2">arrow_forward</v-icon></v-btn>
                    </v-flex>
                </v-layout>
            </v-card-actions>
        </v-card>
...
module.exports = {
    components : {
        ...
        "sales-order-payment-note":httpVueLoader('./sales-order-payment-note.vue'),
    ...
    methods : {
        ...
        add (x, packet) {
            ...
            if (!packet) {
                ...
                for (let i in items) {
                    if (items[i].item_id == x.M_ItemID && items[i].is_packet == 'N') {
                        status = false
                        j = i
                    }
                }
