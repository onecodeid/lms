    ...
    >
        <v-card>
            ...
            <!-- <v-card-actions>
                ...
                <v-btn color="success" @click="generate(true)" :disabled="!selected_admin">Excel</v-btn>
                <v-btn color="success" @click="generate(false)"
            ...
            <v-card-actions>
                ...
                <v-spacer></v-spacer>
                <v-btn color="success" @click="generate('csv')" :disabled="!selected_admin" class="btn-icon" title="Download CSV">CSV</v-btn>
                <v-btn color="success" @click="generate('xls')" :disabled="!selected_admin" class="btn-icon" title="Download Excel">XLS</v-btn>
                <v-btn color="orange" dark @click="generate" :disabled="!selected_admin" class="btn-icon" title="Cetak PDF"><v-icon class="mr-1">print</v-icon> PDF</v-btn>
            </v-card-actions>
        </v-card>
