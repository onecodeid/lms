    ...
    >
        <v-card>
            ...
            <v-card-actions>
                ...
                <v-spacer></v-spacer>
                <v-btn color="success" @click="generate('csv')" class="btn-icon" :disabled="!selected_level" title="Download CSV">CSV</v-btn>
                <v-btn color="success" @click="generate('xls')" class="btn-icon" :disabled="!selected_level" title="Download EXCEL">Excel</v-btn>
                <v-btn color="orange" :dark="!!selected_level" @click="generate()"
                    :disabled="!selected_level" class="btn-icon" title="Cetak PDF"><v-icon class="mr-1">print</v-icon> PDF</v-btn>
            </v-card-actions>
        </v-card>
