         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <master-level-list></master-level-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <master-level-new></master-level-new>
         </v-app>
      </div>
...
methods : {
   ...
   components: {
        ...
        "master-level-list" : httpVueLoader("./components/master-level-list.vue"),
        "master-level-new" : httpVueLoader("./components/master-level-new.vue")
      }
    })
    </script>
    <style>
