         ...
         <v-app id="oneApp" v-if="one_token" >
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <finance-marketplace-list></finance-marketplace-list>
                        <finance-marketplace-show></finance-marketplace-show>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
methods : {
   ...
   components: {
        ...
        "finance-marketplace-list" : httpVueLoader("./components/finance-marketplace-list.vue?t=<?=date('YmdHis')?>"),
        "finance-marketplace-show" : httpVueLoader("./components/finance-marketplace-show.vue?t=<?=date('YmdHis')?>")
      }
    })
    </script>
    <style>
