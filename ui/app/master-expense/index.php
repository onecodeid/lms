         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <master-expense-list></master-expense-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <master-expense-new></master-expense-new>
         </v-app>
      </div>
...
methods : {
   ...
   components: {
        ...
        "master-expense-list" : httpVueLoader("./components/master-expense-list.vue"),
        "master-expense-new" : httpVueLoader("./components/master-expense-new.vue")
      }
    })
    </script>
    <style>
