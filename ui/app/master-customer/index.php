   ...
   <body>
      <div v-cloak id="app">
         <v-app id="oneApp"  v-if="one_token">
            ...
            <master-customer-transfer></master-customer-transfer>
...
methods : {
   ...
   components: {
        ...
        "common-dialog-print" : httpVueLoader("../common/components/common-dialog-print.vue<?php echo $ts ?>"),
        "master-customer-list" : httpVueLoader("./components/master-customer-list.vue<?php echo $ts ?>"),
        "master-customer-list-mobile" : httpVueLoader("./components/master-customer-list-mobile.vue<?php echo $ts ?>"),
        "master-customer-new" : httpVueLoader("./components/master-customer-new.vue<?php echo $ts ?>"),
        "master-customer-filter" : httpVueLoader("./components/master-customer-filter.vue<?php echo $ts ?>"),
        "master-customer-transfer" : httpVueLoader("./components/master-customer-transfer.vue<?php echo $ts ?>")
      }
    })
    </script>
    <style>
