   ...
   <body>
      <div v-cloak id="app">
         <v-app id="oneApp"  v-if="one_token">
            ...
            <v-footer class="footer" app color="orange" v-show="selected_tab == 1">
                <v-btn color="orange" block dark class="white--text pt-4 pb-4 title" @click="save">KE PEMBAYARAN</v-btn>
            </v-footer>
         </v-app>
      </div>
...
methods : {
   ...
   components: {
        ...
        "sales-order-seller-add-form" : httpVueLoader("./components/sales-order-seller-add-form.vue<?=$ts;?>"),
        "sales-order-seller-payment-method" : httpVueLoader("./components/sales-order-seller-payment-method.vue<?=$ts;?>")
      }
    })
    </script>
    <style>
