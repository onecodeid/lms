         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <stat-omzet-customer-per-admin-list></stat-omzet-customer-per-admin-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
methods : {
   ...
   components: {
        ...
        "stat-omzet-customer-per-admin-list" : httpVueLoader("./components/stat-omzet-customer-per-admin-list.vue")
      }
    })
    </script>
    <style>
