...
module.exports = {
    ...
    computed : {
        admins () {
            return this.$store.state.omzet.users
        },

        selected_admin : {
            get () { return this.$store.state.omzet.selected_user },
            set (v) { 
                this.$store.commit('omzet/set_selected_user', v) 
                this.$store.dispatch('omzet/search2', {})
            }
        },

        fees () {
            return this.$store.state.omzet.fees
        },
        ...
        fee_id () {
            return this.$store.state.omzet.selected_omzet.M_ExpenseID
        },

        query : {
            get () { return this.$store.state.omzet.search },
        ...
        xtotal_page () {
            return this.$store.state.omzet.total_fee_page
        },

        edate : {
            get () { return this.$store.state.omzet.edate },
            set (v) { this.$store.commit('fee/set_edate', v) }
        },

        sdate : {
            get () { return this.$store.state.omzet.sdate },
            set (v) { this.$store.commit('fee/set_sdate', v) }
        },

        dtx () {
            return this.$store.state.omzet.dtx
        }
    },
    ...
    mounted () {
        ...
        this.$store.dispatch('omzet/search_user', {})
    }
}
</script>