         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <crm-wa-template-list></crm-wa-template-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <crm-wa-template-new></crm-wa-template-new>
         </v-app>
      </div>
...
methods : {
   ...
   components: {
        ...
        "crm-wa-template-list" : httpVueLoader("./components/crm-wa-template-list.vue<?=$ts;?>"),
        "crm-wa-template-new" : httpVueLoader("./components/crm-wa-template-new.vue<?=$ts;?>")
      }
    })
    </script>
    <style>
