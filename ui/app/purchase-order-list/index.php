         ...
         <v-app id="oneApp" v-if="one_token" >
            ...
            <v-content class="blue lighten-5 one">
               ...
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <purchase-order-list v-if="$vuetify.breakpoint.mdAndUp"></purchase-order-list>
                        <purchase-order-new v-if="$vuetify.breakpoint.mdAndUp"></purchase-order-new>
                        <purchase-order-item-list v-if="$vuetify.breakpoint.mdAndUp"></purchase-order-item-list>
...
methods : {
   ...
   components: {
        ...
        "purchase-order-list" : httpVueLoader("./components/purchase-order-list.vue"),
        "purchase-order-new" : httpVueLoader("./components/purchase-order-new.vue"),
        "purchase-order-item-list" : httpVueLoader("./components/purchase-order-item-list.vue")
      }
    })
    </script>
    <style>
