         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <master-leadtype-list></master-leadtype-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
methods : {
   ...
   components: {
        ...
        "master-leadtype-list" : httpVueLoader("./components/master-leadtype-list.vue"),
        "master-leadtype-new" : httpVueLoader("./components/master-leadtype-new.vue")
      }
    })
    </script>
    <style>
