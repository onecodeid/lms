               ...
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row wrap>
                    <v-flex xs12>
                     ...
                     <v-flex xs12>
                        <watzap-setting v-if="selected_tab.id == 1"></watzap-setting>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
methods : {
   ...
   components: {
        ...
        "master-item-list" : httpVueLoader("./components/master-item-list.vue<?=$ts;?>"),
        "watzap-setting" : httpVueLoader("./components/watzap-setting.vue<?=$ts;?>")
      }
    })
    </script>
    <style>
