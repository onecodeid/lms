<template>
    ...
    >
        ...
        <common-dialog-notif></common-dialog-notif>
        <common-dialog-notice></common-dialog-notice>
    </v-navigation-drawer>
</template>
...
module.exports = {
    components: {
        "common-dialog-notif" : httpVueLoader("./common-dialog-notif.vue"),
        "common-dialog-notice" : httpVueLoader("./common-dialog-notice.vue")
    },
    data () {
        return {
