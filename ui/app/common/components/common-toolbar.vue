<template>
  <v-toolbar dark class="zalfa-bg-pink-01">
    ...
    <v-toolbar-title class="white--text">LPK Global</v-toolbar-title>
    ...
    <v-badge color="red">
        ...
        <v-btn icon class="ma-0 zalfa-btn-notification" @click="info">
            <v-icon>info</v-icon>
        </v-btn>
...
module.exports = {
    ...
    methods : {
        ...
        info () {
            ...
            window.location.replace(URL + '../ui/app/crm-info-2/feed/')
        },
