               ...
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        ...
                        <warehouse-packing-set></warehouse-packing-set>
...
mounted: function() {
    ...
    this.$store.dispatch('packing/search_user')
},
computed : {
    one_token () {
...
methods : {
   ...
   components: {
        ...
        "warehouse-packing-list" : httpVueLoader("./components/warehouse-packing-list.vue"),
        "warehouse-packing-set" : httpVueLoader("./components/warehouse-packing-set.vue"),
