         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs4 pr-1>
                        <master-packet-list></master-packet-list>
                     </v-flex>

                     <v-flex xs8>
                         <master-packet-detail-list v-show="selected_tab==1"></master-packet-detail-list>
            ...
            <master-packet-new></master-packet-new>
            <v-snackbar
                v-model="snackbar"
                multi-line
                :timeout="3000"
...
methods : {
   ...
   components: {
        ...
        "master-packet-list" : httpVueLoader("./components/master-packet-list.vue?t=<?=date('YmdHis')?>"),
        "master-packet-new" : httpVueLoader("./components/master-packet-new.vue<?= $ts; ?>"),
        "master-packet-detail-list" : httpVueLoader("./components/master-packet-detail-list.vue<?= $ts; ?>"),
        "master-packet-detail-item-list" : httpVueLoader("./components/master-packet-detail-item-list.vue<?= $ts; ?>"),
        "master-packet-detail-price" : httpVueLoader("./components/master-packet-detail-price.vue<?= $ts; ?>"),
        "master-packet-detail-fees" : httpVueLoader("./components/master-packet-detail-fees.vue<?= $ts; ?>")
      }
    })
    </script>
    <style>
