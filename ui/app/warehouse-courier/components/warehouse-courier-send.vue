        ...
        <v-card-text>
            ...
            <v-card flat>
                <v-card-text>
                    <v-layout row wrap>
                        <v-flex xs6>
                            <v-textarea label="Nama Kurir (opsional)" rows="4" placeholder=" " outline v-model="courier_name"></v-textarea>
                            <!-- <v-text-field
                        ...
                        <v-flex xs6 pl-1>
                            <v-textarea label="Catatan" rows="4" placeholder=" " outline v-model="courier_note"></v-textarea>
                            <!-- <v-text-field
                                label="Catatan"
                                placeholder=" "
                            ></v-text-field> -->
...
module.exports = {
    ...
    computed : {
        dialog : {
            get () { return this.$store.state.warehouse.dialog_item },
            set (v) { this.$store.commit('warehouse/set_common', ['dialog_item', v]) }
        },
    ...
    methods : {
       one_money (x) {
        ...
        send () {
            this.$store.dispatch('warehouse/send')
            this.$store.commit('warehouse/set_common', ['dialog_item', false])
        }
    },
