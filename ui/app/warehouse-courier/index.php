         ...
         <v-app id="oneApp" v-if="one_token" >
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <warehouse-courier-list></warehouse-courier-list>
                        <warehouse-courier-send></warehouse-courier-send>
                        <warehouse-courier-receipt></warehouse-courier-receipt>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
...
mounted: function() {
    ...
    this.$store.dispatch('warehouse/search_expedition')
},
computed : {
    one_token () {
...
methods : {
   ...
   components: {
        ...
        "warehouse-courier-list" : httpVueLoader("./components/warehouse-courier-list.vue"),
        "warehouse-courier-send" : httpVueLoader("./components/warehouse-courier-send.vue"),
        "warehouse-courier-receipt" : httpVueLoader("./components/warehouse-courier-receipt.vue")
      }
    })
    </script>
    <style>
