         ...
         <v-app id="oneApp"  v-if="one_token">
            ...
            <common-navbar></common-navbar>
               <v-container pt-1 pl-1 pr-1 fluid>
                  <v-layout row>
                     <v-flex xs12>
                        <master-general-list v-show="$vuetify.breakpoint.mdAndUp"></master-general-list>
                     </v-flex>
                  </v-layout>
               </v-container>
            </v-content>
            ...
            <master-general-new></master-general-new>
...
methods : {
   ...
   components: {
        ...
        "master-general-list" : httpVueLoader("./components/master-general-list.vue"),
        "master-general-new" : httpVueLoader("./components/master-general-new.vue"),
        // "master-general-filter" : httpVueLoader("./components/master-general-filter.vue")
      }
    })
    </script>
    <style>
