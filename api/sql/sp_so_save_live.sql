...
IF order_id = 0 THEN
	...
	SELECT now(), order_number, pcustomer, M_OrderStatusID, expedition_id, servicex, courier_cost, ex_other, ex_note, payment_id, channel, is_ds, seller, ds_customer_id, order_note, coupon_amount, IF(payment_code = 'COD', 'Y', 'N')
