DROP PROCEDURE `sp_inventory_adjust_warehouse_save`;
DELIMITER ;;
CREATE PROCEDURE `sp_inventory_adjust_warehouse_save` (IN `adjust_id` int, IN `warehouse_id` int, IN `jdata` text, IN `adjust_note` text, IN `uid` int)
BEGIN
