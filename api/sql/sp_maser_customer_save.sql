...
IF address_id IS NULL THEN
    ...
    SELECT customerid, "Alamat Utama", customer_address, customer_kelurahan, customer_district, 
...
ELSE
    ...
    SET M_DeliveryAddressDesc = customer_address,
                    M_DeliveryAddressM_KelurahanID = customer_kelurahan,
                    M_DeliveryAddressM_DistrictID = customer_district,
...
WHILE n < l DO
    ...
    IF address_id = 0 THEN
        ...
        SELECT customerid, address_name, address_desc, address_village, address_district, address_city, address_postcode, address_phones, address_pic_name;
