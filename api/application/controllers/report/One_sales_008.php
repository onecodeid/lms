...
class One_sales_008 extends RPT_Controller
{
    ...
    function index() {
        ...
        $r = $this->r_report->one_sales_008( $this->input->get('level_id'), $this->input->get('sdate'), $this->input->get('edate') );
        ...
        if (isset($this->sys_input['out']))
        {
            if ($this->sys_input['out'] == 'csv')
            {
                ...
                $level_name = isset($r[0][0])?$r[0][0]['M_CustomerLevelName'] : 'all';
                $this->csv($data, 'penjualan_detail_per_jenjang_' .
                    $level_name . '_' .
        ...
        if ($r)
        {
            ...
            $this->my_header($this, 
                'Laporan Detail Penjualan Per Jenjang', 
                'Jenjang : '.$r['M_CustomerLevelName'].' | Periode : ' . date('d/m/Y', strtotime($this->input->get('sdate'))) . ' - ' .  date('d/m/Y', strtotime($this->input->get('edate'))), 'L');
