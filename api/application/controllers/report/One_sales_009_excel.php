...
class One_sales_009_excel extends RPT_Controller
{
    var $report_code;
    // var $pdf;
    ...
    function index() {
        ...
        $r = $this->r_report->one_sales_009( $sdate, $edate );
        //
        $grand_total = 0;
        $sub_total = 0;
        
        $filename = "laporan_detail_penjualan_per_tanggal_".date('d.m.Y', strtotime($this->input->get('sdate')))."_".date('d.m.Y', strtotime($this->input->get('edate'))).".xls";
        ...
        if ($r)
        {
            ...
            $objPHPExcel = $objReader->load("./assets/template_sales_009.xls");
