...
class Rajaongkir extends MY_Controller
{
    ...
    function sync_city()
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => $this->RO_URL."city?province=21",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
    ...
    function sync_district()
    {
        ...
        $x = $this->db->where('M_CityID', 256)->get('m_city')->result_array();
        ...
        foreach ($x as $y => $z)
        {
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => $this->RO_URL."subdistrict?city=127",
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => "",
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 30,
            ...
            echo "cURL Error #:" . $err;
                ...
                foreach ($d->rajaongkir->results as $k => $v)
                {
                    ...
                    $this->db->query("INSERT INTO m_district(M_DistrictName, M_DistrictM_CityID, M_DistrictROID) SELECT ?, ?, ?", [$v->subdistrict_name, 256, $v->subdistrict_id]);
